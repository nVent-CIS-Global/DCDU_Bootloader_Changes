...
{
    int i;
# 205 "/opt/microchip/xc8/v2.46/pic/sources/c99/common/doprnt.c"
 if (p < 0) {
  p = 0;
 }
    i = 0;
...
# 1176 "/opt/microchip/xc8/v2.46/pic/sources/c99/common/doprnt.c"
static void
...
# 1439 "/opt/microchip/xc8/v2.46/pic/sources/c99/common/doprnt.c"
  if (0
    ...
    || *cp == 'x'
# 1452 "/opt/microchip/xc8/v2.46/pic/sources/c99/common/doprnt.c"
    ) {
# 1495 "/opt/microchip/xc8/v2.46/pic/sources/c99/common/doprnt.c"
   ...
   *fmt = cp+1;
   switch (*cp) {
# 1550 "/opt/microchip/xc8/v2.46/pic/sources/c99/common/doprnt.c"
    case 'x':
