...
# 85 "mcc_generated_files/nvm/src/../nvm.h"
...
# 151 "mcc_generated_files/nvm/src/../nvm.h"
_Bool NVM_IsBusy(void);
# 160 "mcc_generated_files/nvm/src/../nvm.h"
...
# 271 "mcc_generated_files/nvm/src/../nvm.h"
eeprom_data_t EEPROM_Read(eeprom_address_t address);
# 284 "mcc_generated_files/nvm/src/../nvm.h"
...
static void (*NVM_Callback) (void) = ((void*)0);
...
nvm_status_t FLASH_RowRead(flash_address_t address, flash_data_t *dataBuffer)
{
    flash_data_t *bufferRamPtr = (flash_data_t *) ((0x3700U));
    uint16_t flashDataCount = (256U);
...
nvm_status_t FLASH_Write(flash_address_t address, uint16_t data)
{
    ...
    __asm("asmopt push");
    __asm("asmopt off");
    __asm("banksel(_NVMLOCK)");
    NVMLOCK = unlockKeyLow;
    __asm("MOVF (_unlockKeyHigh&0xFF),w,c");
    __asm("MOVWF (_NVMLOCK&0xFF),b");


    __asm("bsf (_NVMCON0bits&0xFF)," "0x0" ",b");
    __asm("asmopt pop");
...
flash_address_t FLASH_PageAddressGet(flash_address_t address)
{
    return (flash_address_t) (address & (((0x020000U) - 1U) ^ ((256U) - 1U)));
}

uint16_t FLASH_PageOffsetGet(flash_address_t address)
{
    return (uint16_t) (address & ((256U) - 1U));
}
...
__attribute__((inline)) void NVM_InterruptEnable(void)
{
    PIE15bits.NVMIE = 1;
}

__attribute__((inline)) void NVM_InterruptDisable(void)
{
    PIE15bits.NVMIE = 0;
}
